...
public class FacilitysoftApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		 ...
		 * Categoria(null, "Escritório"); Categoria cat3 = new Categoria(null,
		 * "Cama mesa e banho"); Categoria cat4 = new Categoria(null, "Eletrônicos");
		 * Categoria cat5 = new Categoria(null, "Jardinagem"); Categoria cat6 = new
		 * Categoria(null, "Decoração"); Categoria cat7 = new Categoria(null,
		 * "Perfumaria");
		 * 
		 ...
		 * cat7)); produtoRepository.saveAll(Arrays.asList(p1, p2, p3));
		 * 
		 * Estado est1 = new Estado(null, "Minas Gerais"); Estado est2 = new
		 * Estado(null, "São Paulo");
		 * 
		 * Cidade c1 = new Cidade(null, "Uberlãndia", est1); Cidade c2 = new
		 * Cidade(null, "São Paulo", est2); Cidade c3 = new Cidade(null, "Campinas",
		 * est2);
		 * 
		 ...
		 * 
		 * Cliente cli1 = new Cliente(null, "Marioa Silva", "maria@gamil.com",
		 * "21996689897", TipoCliente.PESSOAFISICA);
		 * cli1.getTelefones().addAll(Arrays.asList("22228888", "77788999"));
		 * 
		 * Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardin",
		 * "38220834", cli1, c1); Endereco e2 = new Endereco(null, "Avenida Matos",
		 ...
		 * 
		 * SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy HH:mm"); Pedido ped1
		 * = new Pedido(null, sdf.parse("30/09/2017 10:32"), cli1, e1); Pedido ped2 =
		 * new Pedido(null, sdf.parse("10/10/2017 19:35"), cli1, e2);
		 * 
		 * Pagamento pagto1 = new PagamentoComCartão(null, EstadoPagamento.QUITADO,
		 * ped1, 6); ped1.setPagamento(pagto1);
		 * 
		 * Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE,
		 * ped2, sdf.parse("20/10/2017 00:00"), null); ped2.setPagamento(pagto2);
		 * 
		 ...
		 * 
		 * ItemPedido ip1 = new ItemPedido(ped1, p1, 0.00, 1, 2000.00); ItemPedido ip2 =
		 * new ItemPedido(ped1, p3, 0.00, 2, 80.00); ItemPedido ip3 = new
		 * ItemPedido(ped2, p2, 0.00, 1, 800.00);
		 * 
